...
export function HeaderComponent () {
  ...
  return (
    <Div className="w-full bg-black px-6 md:px-24 py-4 flex items-center relative z-50">
      ...
      <Div className="hidden md:flex items-center gap-x-4 ml-auto">
        ...
        <Button type="button" btnText="Get Started" className="h-10 px-6 text-base bg-slate-50 text-black" />
      </Div>
  ...
  <Div className="fixed top-0 left-0 w-full h-screen bg-black bg-opacity-90 backdrop-blur-md flex flex-col items-center justify-center space-y-6 z-50 animate-fade-down">
    <p className="text-white text-xl hover:text-gray-400 cursor-pointer">Home</p>
    <p className="text-white text-xl hover:text-gray-400 cursor-pointer">Projects</p>
    <p className="text-white text-xl hover:text-gray-400 cursor-pointer">About</p>

    <Div className="flex items-center justify-center w-40 h-12 bg-white/10 rounded-md border border-white/10 px-4 cursor-pointer">
      <span className="text-gray-300 mr-2 whitespace-nowrap">Get in touch</span>
      <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 4h16v16H4V4zm0 0l8 8 8-8" />
      </svg>
